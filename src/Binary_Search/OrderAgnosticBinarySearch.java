...
//Order Agnostic means when we don't know whether array is sorted in Ascending or Descending order
...
//        int[] arr = {22,21,13,12,9,8,5,3,1,-1,-4,-6,-8,-18,-22}; // descending order array
        ...
        if (isAscending){
            System.out.println(applyAscending(arr, 22));
        }
        else
            System.out.println(applyDescending(arr, 22));
    }
